...
export function colorClass({
  ...
  const bgCls = classNames(
    ...
    { [`bg-${bg}-100 !text-black dark:!text-default-200`]: bg === 'default' }, // bg-default-100 !text-black
  );
