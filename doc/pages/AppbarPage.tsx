  ...
  return (<Article>
    <>
      ...
      <CompExample
        title="搜索"
        desc={
          '支持进行搜索——通过提供一个 `searchCallback` 即可。如果你需要自定义搜索框，则需要使用 `tailing`。'
        }
      >
        <Appbar
          varient="default"
      ...
      <CompExample
        title="前端控件"
        desc="而使用 leading，可以在前端追加控件，通常我们会在这里放一个 menu 按钮。"
      >
        <Appbar
          varient="default"
