  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      <div style={{ display: 'flex', gap: 8 }}>
        <Btn.Counter size="sm" value={2} icon="chat_bubble" />
        <Btn.Counter size="sm" color="red" value={4} icon="favorite" />
        <Btn.Counter size="sm" color="green" value={7} icon="reply" />
      </div>
      <div style={{ display: 'flex', gap: 8 }}>
        <Btn.Counter size="md" value={2} icon="chat_bubble" />
        <Btn.Counter size="md" color="red" value={4} icon="favorite" />
        <Btn.Counter size="md" color="green" value={7} icon="reply" />
      </div>
      <div style={{ display: 'flex', gap: 8 }}>
        <Btn.Counter size="lg" value={2} icon="chat_bubble" />
        <Btn.Counter size="lg" color="red" value={4} icon="favorite" />
        <Btn.Counter size="lg" color="green" value={7} icon="reply" />
      </div>
    </div>
  );
}
